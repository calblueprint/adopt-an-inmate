    ...
    <div className="space-y-4">
      ...
      <section>
        ...
        <p className="text-[0.875rem] leading-normal font-medium text-[var(--color-gray-8)]">
          ...
          services. Information on the Service is for general informational and
          educational purposes only and does not create an attorney-client,
          therapist-client, or similar professional relationship. Matches and
          communications are voluntary. We do not guarantee placements,
          outcomes, or replies.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-[0.875rem] leading-normal font-medium text-[var(--color-gray-8)]">
          ...
          outside guidelines we provide. Share others&apos; private information
          without consent, including personal addresses, phone numbers, or
          identifying details. Impersonate any person or entity; misrepresent
          your identity or affiliations. Circumvent security features; upload
          malware; or interfere with Service operation. Use the Service for any
          unlawful purpose or in violation of prison or correctional policies.
          We may moderate, restrict, or remove content and accounts at our
          discretion to protect participants and the organization.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-[0.875rem] leading-normal font-medium text-[var(--color-gray-8)]">
          ...
          solely to operate, improve, and provide the Service. You represent you
          have the rights to submit User Content and that it does not infringe
          others&apos; rights or violate these Terms.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-[0.875rem] leading-normal font-medium text-[var(--color-gray-8)]">
          ...
          REVENUE, ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICE. OUR
          TOTAL LIABILITY FOR ANY CLAIM SHALL NOT EXCEED $100 OR THE AMOUNT YOU
          PAID TO US FOR THE SERVICE IN THE 12 MONTHS BEFORE THE CLAIM,
      ...
      <section>
        ...
        <p className="text-[0.875rem] leading-normal font-medium text-[var(--color-gray-8)]">
          ...
          County, Oregon, for any dispute not subject to small-claims court.
        </p>
      </section>
